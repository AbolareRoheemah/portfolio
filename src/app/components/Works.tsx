    ...
    <div className='works-bg flex flex-col items-center justify-start gap-2 pt-2 px-20 pb-20 h-screen relative'>
        ...
        <div className='flex flex-col items-center justify-start gap-2 text-center relative z-10'>
            ...
            <div className='flex items-center justify-center gap-20 mt-10 mb-14'>
                ...
                <div className="leaf-shaped py-8 px-10 border-2 flex flex-col items-left justify-start bg-[#0D1117] rounded-tl-[100px] rounded-br-[100px] relative z-10 w-[400px]">
                            <div className='flex flex-col items-center justify-start'>
                                <div className="w-full h-[250px] rounded-tl-[100px] rounded-br-[100px] bg-cover bg-center bg-no-repeat border-2 border-[#6EF4E6]" style={{backgroundImage: "url('/vizientCoop.png')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
                                </div>
                            </div>
                ...
                <div className="leaf-shaped py-8 px-10 border-2 flex flex-col items-left justify-start bg-[#0D1117] rounded-tl-[100px] rounded-br-[100px] relative z-10 w-[400px]">
                            <div className='flex flex-col items-center justify-start'>
                                <div className="w-full h-[250px] rounded-tl-[100px] rounded-br-[100px] bg-cover bg-center bg-no-repeat border-2 border-[#6EF4E6]" style={{backgroundImage: "url('/reablock.png')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
                                </div>
                            </div>
                            <div className='mt-6 text-[#9B9EA1]'>
                                <div className='flex items-start justify-start mb-4 gap-2'> 
                                    <p><WorkOutlineOutlined className='text-[#6AECD9]' /></p>
                                    <p className='text-left'><span className='text-[#6df2db] text-[26px]font-bold'>Reablock</span> - Real estate management website</p>
                                </div>
                                <div className='flex items-start justify-start gap-4 mb-4'>
                                    <img src="/link.svg" alt="" width={24} height={24} />
                ...
                <div className="leaf-shaped py-8 px-10 border-2 flex flex-col items-left justify-start bg-[#0D1117] rounded-tl-[100px] rounded-br-[100px] relative z-10 w-[400px]">
                            <div className='flex flex-col items-center justify-start'>
                                <div className="w-full h-[250px] rounded-tl-[100px] rounded-br-[100px] bg-cover bg-center bg-no-repeat border-2 border-[#6EF4E6]" style={{backgroundImage: "url('/web3L.png')", backgroundSize: 'cover', backgroundPosition: 'center'}}>
                                </div>
                            </div>
                            <div className='mt-6 text-[#9B9EA1]'>
                                <div className='flex items-start justify-start mb-4 w-full  gap-2'>
                                    <p><WorkOutlineOutlined className='text-[#6AECD9]' /></p>
                                    <p className='text-left'><span className='text-[#6df2db] text-[26px]font-bold'>Web3Learner</span> - The UI of a  platform to learn web3 technologies and languages</p>
                                </div>
                                <div className='flex items-start justify-start gap-4 mb-4'>
                                    <img src="/link.svg" alt="" width={24} height={24} />
