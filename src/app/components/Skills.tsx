            ...
            <div className='flex flex-col md:flex-row items-center justify-center gap-4 md:gap-20 mt-10 mb-14'>
                ...
                <div className='flex items-center justify-center gap-4 flex-wrap mb-20'>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#e54f2d]'>
                            <img src="./html5.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#e54f2d]'>HTML</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#1e72b8]'>
                            <img src="./css3.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#1e72b8]'>CSS</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#e8a02e]'>
                            <img src="./nodedotjs.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#e8a02e]'>JS</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#3eaae1]'>
                            <img src="./preact.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#3eaae1]'>React</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#ffffff]'>
                            <img src="./nextdotjs.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#fff]'>Next</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#4FC08D]'>
                            <img src="./vuedotjs.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#4FC08D]'>Vue</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#00DC82]'>
                            <img src="./nuxtdotjs.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#00DC82]'>Nuxt</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#06B6D4]'>
                            <img src="./tailwindcss.svg" alt="" />
                        </div>
                        <p className='mt-2 text-[#06B6D4]'>Tailwind</p>
                    </div>
                    < div className='flex flex-col items-center justify-center'>
                        <div className='flex items-center justify-center rounded-full mx-4 p-4 w-[60px] h-[60px] md:w-[80px] md:h-[80px] bg-[#363636]'>
