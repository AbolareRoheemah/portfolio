    ...
    <div className='flex flex-col items-center justify-start gap-2 pt-2 md:px-20 px-8 pb-20 min-h-screen relative'>
        ...
        <div className='flex flex-col items-center justify-start gap-2 text-center relative z-10 w-full mt-14'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start gap-10 border-y-2 border-[#696E71] py-10 mt-10'>
                <div>
                    <img src="/erc20pic.jpg" alt="" data-aos="flip-up" className='min-w-[20vw] md:w-[25vw] md:h-[35vh] w-full h-full rounded-md' />
                </div>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start gap-10 border-b-2 border-[#696E71] pb-10 mt-10'>
                <div>
                    <img src="/sendtrsfcall.jpg" alt="" data-aos="flip-up" className='min-w-[20vw] md:w-[25vw] md:h-[35vh] w-full h-full rounded-md' />
                </div>
                <div className='text-left'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start gap-10 border-b-2 border-[#696E71] pb-10 mt-10'>
                <div>
                    <img src="/merkleimg.avif" alt="" data-aos="flip-up" className='min-w-[20vw] md:w-[25vw] md:h-[35vh] w-full h-full rounded-md' />
                </div>
                <div className='text-left'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start gap-10 border-b-2 border-[#696E71] pb-10 mt-10'>
                <div>
                    <img src="/insideEVM.jpg" alt="" data-aos="flip-up" className='min-w-[20vw] md:w-[25vw] md:h-[35vh] w-full h-full rounded-md' />
                </div>
                <div className='text-left'>
            ...
            <div className='flex flex-col md:flex-row items-start justify-start gap-10 border-b-2 border-[#696E71] pb-10 mt-10'>
                <div>
                    <img src="/nftimage.webp" alt="" data-aos="flip-up" className='min-w-[20vw] md:w-[25vw] md:h-[35vh] w-full h-full rounded-md' />
                </div>
                <div className='text-left'>
